    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart_id', models.CharField(blank=True, max_length=120, verbose_name='Unique Cart ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item_id', models.CharField(blank=True, max_length=120, verbose_name='Unique Item ID')),
